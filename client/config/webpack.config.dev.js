...
module.exports = {
	mode: "development", // You may want 'eval' instead if you prefer to see the compiled output in DevTools.
				...
				oneOf: [// "url" loader works like "file" loader except that it embeds assets
					...
					// The preset includes JSX, Flow, and some ESnext features.
					{
						...
						options: {
							...
							cacheDirectory: true, // Don't waste time on Gzipping the cache
