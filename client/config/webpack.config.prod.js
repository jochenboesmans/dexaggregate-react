...
module.exports = {
	...
	output: {
		...
		chunkFilename: "static/js/[name].[chunkhash:8].chunk.js", // We
	                                                            // inferred
	                                                            // the
	                                                            // "public
	                                                            // path"
	...
	plugins: [// Generates an `index.html` file with the <script> injected.
		...
		// a network request.
		shouldInlineRuntimeChunk && new InlineChunkHtmlPlugin(HtmlWebpackPlugin, [/runtime~.+[.]js/]), // Makes some
	                                                                                                 // environment
	                                                                                                 // variables
	                                                                                                 // available in
	                                                                                                 // index.html.
		...
		new webpack.DefinePlugin(env.stringified), new MiniCssExtractPlugin({
		...
		new webpack.IgnorePlugin(/^\.\/locale$/, /moment$/), // Generate a service worker script that will precache, and
	                                                       // keep up to date,
