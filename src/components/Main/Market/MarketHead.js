...
const MarketHead = () => {
	...
	const columnTwoDescription = `The difference between the highest current bid ratio and the lowest current ask ratio across all exchanges for the given market pair. Negative values (where the lowest current ask is lower than the highest current bid) indicate potential arbitrage opportunities between exchanges. All ratios are denominated in DAI for readability and ease of interpretation.`;
